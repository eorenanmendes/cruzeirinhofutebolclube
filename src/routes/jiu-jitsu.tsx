    ...
    <div className="min-h-screen bg-neutral-950 text-white selection:bg-blue-600/30 font-sans">
      ...
      <section className="relative min-h-screen flex items-center pt-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <span className="inline-block px-4 py-1 bg-blue-600/20 text-blue-500 text-[10px] font-black uppercase tracking-widest rounded-full border border-blue-600/30 mb-8 backdrop-blur-sm">A Arte Suave na Zona Leste</span>
            <h1 className="text-6xl md:text-9xl font-black mb-8 leading-[0.85] tracking-tighter italic uppercase">
              Disciplina & <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-800">Poder.</span>
            </h1>
      ...
      <section id="sobre" className="py-32 px-6 relative">
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
          <Shield className="w-16 h-16 text-blue-500 mb-12" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center mb-20">
            <h2 className="text-5xl md:text-8xl font-black italic uppercase tracking-tighter relative">
              <span className="absolute -top-10 left-1/2 -translate-x-1/2 text-[10rem] opacity-5 text-blue-500 select-none">TATAME</span>
              Nossa Galeria
            </h2>
          </div>
      ...
      <footer className="py-20 px-6 border-t border-white/5 bg-black flex flex-col items-center gap-8">
        <div className="flex items-center gap-3">
          ...
          <span className="text-lg font-black italic uppercase tracking-tighter">Cruzeirinho Jiu-Jitsu</span>
        </div>
